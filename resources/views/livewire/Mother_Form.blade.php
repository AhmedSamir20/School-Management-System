    ...
    <div style="display: none" class="row setup-content" id="step-2">
        ...
        <div class="col-xs-12">
            <div class="col-md-12">
                ...
                <button class="btn btn-danger btn-sm nextBtn btn-lg " type="button" wire:click="back(1)">
                    {{trans('Parent_trans.Back')}}
                </button>
                @if($updateMode)
                    <button class="btn btn-success btn-sm nextBtn btn-lg " wire:click="secondStepSubmit_edit"
                            type="button">{{trans('Parent_trans.Next')}}
                    </button>
                @else
                    <button class="btn btn-success btn-sm nextBtn btn-lg " type="button"
