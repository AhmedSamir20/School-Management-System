    ...
    <div style="display:@if($currentStep != 1) none @endif" class=" setup-content" id="step-1">
        ...
        <div class="col-xs-12">
            <div class="col-md-12">
                ...
                @if($updateMode)
                    <button class="btn btn-success btn-sm nextBtn btn-lg " wire:click="firstStepSubmit_edit"
                            type="button">{{trans('Parent_trans.Next')}}
                    </button>
                @else
                <button class="btn btn-success btn-sm nextBtn btn-lg " wire:click="firstStepSubmit"
                        type="button">{{trans('Parent_trans.Next')}}
                </button>
                @endif
            </div>
