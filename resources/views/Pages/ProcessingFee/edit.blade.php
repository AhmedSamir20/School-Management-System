...
@section('page-header')
    <!-- breadcrumb -->
@section('PageTitle')
    {{__('Processing.edit_Processors')}}   : <label style="color: red">{{$ProcessingFee->student->name}}</label>
@stop
<!-- breadcrumb -->
@endsection
@section('content')
            ...
            <div class="card card-statistics h-100">
                <div class="card-body">
                    ...
                    <form action="{{route('ProcessingFee.update','test')}}" method="post" autocomplete="off">
                        ...
                        <button class="btn btn-success btn-sm nextBtn btn-lg pull-right" type="submit">{{trans('Processing.submit')}}</button>
                    </form>
