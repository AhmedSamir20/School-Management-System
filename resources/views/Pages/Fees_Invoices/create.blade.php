...
@section('page-header')
    <!-- breadcrumb -->
@section('PageTitle')
{{__('Fees.Add_invoice')}} {{$student->name}}
@stop
<!-- breadcrumb -->
@endsection
@section('content')
                                ...
                                <div data-repeater-list="List_Fees">
                                    <div data-repeater-item>
                                        <div class="row">
                                            ...
                                            <div class="col">
                                                <label for="Name" class="mr-sm-2">{{__('Fees.name')}}</label>
                                            ...
                                            <div class="col">
                                                ...
                                                <div class="box">
                                                    <select class="fancyselect" name="fee_id" required>
                                                        <option value="">-- {{__('Fees.Choose_list')}} --</option>
                                                        @foreach($fees as $fee)
                                            ...
                                            <div class="col">
                                                <label for="description" class="mr-sm-2">{{__('Fees.Statement')}}</label>
                                                <div class="box">
