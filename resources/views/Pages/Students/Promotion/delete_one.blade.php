        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="{{route('Promotions.destroy','test')}}" method="post">
                    ...
                    <h5 style="font-family: 'Cairo', sans-serif;">{{__('Students_trans.Retreat-all-student')}} </h5>
                    <input type="text" class="form-control" readonly value="{{$promotion->student->name}}">
