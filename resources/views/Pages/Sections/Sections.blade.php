        ...
        <div class="col-md-12 mb-30">
            <div class="card card-statistics h-100">
                ...
                <div class="card card-statistics h-100">
                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        <td>
                                                                            ...
                                                                            <a href="#" class="btn btn-outline-danger btn-sm"
                                                                               data-toggle="modal" data-target="#delete{{ $list_Sections->id }}">{{ trans('Sections_trans.Delete') }}</a>
                                                                        </td>
                                                                    </tr>
                                                                    @include('Pages.Sections.editForm')
                                                                    @include('Pages.Sections.deleteForm')
                                                                @endforeach
                                                                </tbody>
                                                            </table>
                                                        </div>
                    ...
                    <!--===Add a New Section ===-->
                    @include('Pages.Sections.addForm')
                </div>
            </div>
            <!-- row closed -->
@endsection
